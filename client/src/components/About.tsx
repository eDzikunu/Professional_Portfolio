        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="rounded-lg shadow-lg overflow-hidden">
              <svg
                className="w-full h-96 bg-slate-100 text-slate-400"
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-slate-700">B.S. Computer Science</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-secondary" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                </svg>
                <span className="text-slate-700">5+ Years Experience</span>
              </div>
            </div>
            
            <a 
              href="/resume.pdf" 
              className="inline-flex items-center space-x-2 text-secondary hover:text-blue-600 font-medium"
              target="_blank"
