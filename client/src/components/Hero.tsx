...
export default function Hero() {
  return (
    <section id="hero" className="min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-br from-slate-100 to-white">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        >
          ...
          <p className="text-slate-600 text-lg md:text-xl mb-8 max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a 
              href="#contact"
              className="border border-secondary text-secondary hover:bg-secondary hover:text-white px-6 py-3 rounded-md transition-colors text-center font-medium"
            >
              Get In Touch
            </a>
          </div>
