                ...
                <div className="pt-6">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 p-3 rounded-full transition-colors"
                      aria-label="GitHub"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input
                    ...
                    } rounded-md focus:outline-none focus:ring-2 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:text-white`}
                    {...register("name")}
                  />
                  {errors.name && (
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-2 border ${
                      errors.message
                        ? "border-red-300 focus:ring-red-500"
                        : "border-slate-300 focus:ring-blue-500"
                    } rounded-md focus:outline-none focus:ring-2 focus:ring-opacity-50 resize-none dark:bg-gray-800 dark:border-gray-600 dark:text-white`}
                    {...register("message")}
                  ></textarea>
                  {errors.message && (
                    <p className="mt-1 text-sm text-red-600 dark:text-red-400">
