        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          >
            <div className="flex items-center space-x-4 mb-6">
              <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-secondary dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-wrap gap-2">
              {FrontEndSkills.map((skill, index) => (
                <span key={index} className="skill-badge px-3 py-1 bg-slate-100 dark:bg-gray-600 text-slate-700 dark:text-slate-200 rounded-full text-sm transition-transform hover:-translate-y-1">
                  {skill}
                </span>
              ))}
            </div>
          ...
          >
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h3 className="text-xl font-bold dark:text-white">Tools & Other</h3>
            </div>
